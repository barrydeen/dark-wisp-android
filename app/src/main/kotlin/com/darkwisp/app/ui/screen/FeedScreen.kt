...
import com.darkwisp.app.ui.component.isGalleryEvent
...
import com.darkwisp.app.ui.component.WispDrawerContent
...
import com.darkwisp.app.relay.BroadcastState
import com.darkwisp.app.viewmodel.FeedContentFilter
import com.darkwisp.app.viewmodel.FeedType
import com.darkwisp.app.viewmodel.FeedViewModel
import com.darkwisp.app.viewmodel.InitLoadingState
import com.darkwisp.app.viewmodel.PowStatus
import com.darkwisp.app.viewmodel.RelayFeedStatus
import com.darkwisp.app.viewmodel.TrendingMetric
import com.darkwisp.app.viewmodel.TrendingMode
import com.darkwisp.app.viewmodel.TrendingTimeframe
import com.darkwisp.app.viewmodel.buildTrendingRelayUrl
...
import com.darkwisp.app.viewmodel.TRENDING_USERS_RELAY_URL
...
fun FeedScreen(
    ...
    onViewSetFeed: ((com.darkwisp.app.nostr.InterestSet) -> Unit)? = null,
    ...
    DisposableEffect(Unit) {
        com.darkwisp.app.ui.component.emojiRemoveCallback = { emoji ->
            viewModel.customEmojiRepo.removeUnicodeEmoji(emoji)
        }
        onDispose { com.darkwisp.app.ui.component.emojiRemoveCallback = null }
    }
...
private fun FeedItem(
    ...
    nip05Version: Int = 0,
    followList: List<com.darkwisp.app.nostr.Nip02.FollowEntry> = emptyList(),
...
private fun FeedArticleItem(
    ...
    Surface(
        ...
        Column {
            ...
            // Action bar
            com.darkwisp.app.ui.component.ActionBar(
                onReply = onReply,
                onReact = onReact,
                userReactionEmojis = userEmojis,
                onRepost = onRepost,
...
private fun HashtagPickerDialog(
    sets: List<com.darkwisp.app.nostr.InterestSet>,
    isLoading: Boolean = false,
    onSelectHashtag: (String) -> Unit,
    onViewSetFeed: (com.darkwisp.app.nostr.InterestSet) -> Unit,
...
private fun TrendingFilterBar(
    ...
    val metricIcon = @Composable { m: TrendingMetric ->
        when (m) {
            ...
            TrendingMetric.ZAPS -> Icon(painter = androidx.compose.ui.res.painterResource(com.darkwisp.app.R.drawable.ic_bolt), contentDescription = m.label, modifier = Modifier.size(14.dp))
        }
    }
...
private fun TrendingUsersContent(
    ...
    isLoading: Boolean,
    relayFeedStatus: RelayFeedStatus,
    contactRepo: com.darkwisp.app.repo.ContactRepository,
    onProfileClick: (String) -> Unit,
