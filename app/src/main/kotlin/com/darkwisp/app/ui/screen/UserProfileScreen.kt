...
import com.darkwisp.app.ui.component.ContentSegment
import com.darkwisp.app.ui.component.FullScreenImageViewer
...
import com.darkwisp.app.ui.component.parseContent
import com.darkwisp.app.ui.component.parseImetaTags
import com.darkwisp.app.ui.component.ProfileQrSheet
import com.darkwisp.app.ui.component.ProfilePicture
import com.darkwisp.app.ui.component.RichContent
import com.darkwisp.app.ui.component.ZapDialog
import com.darkwisp.app.viewmodel.ProfileSortMode
...
fun UserProfileScreen(
    ...
    if (fullScreenMediaVideoUrl != null) {
        com.darkwisp.app.ui.component.FullScreenVideoPlayer(
                    ...
                    if (pinnedEvents.isNotEmpty()) {
                        ...
                        items(items = pinnedEvents, key = { "pinned-${it.id}" }) { event ->
                            ...
                            val pinnedTranslationState = remember(translationVersion, event.id) {
                                translationRepo?.getState(event.id) ?: com.darkwisp.app.repo.TranslationState()
                            }
                            ...
                            Row(
                                ...
                                for (event in row) {
                                    val firstMedia = remember(event.id) {
                                        val img = com.darkwisp.app.nostr.Nip68.parseImetaEntries(event).firstOrNull()
                                        val vid = com.darkwisp.app.nostr.Nip71.parseVideoMeta(event).firstOrNull()
                    ...
                    if (groupsLoading && groups.isEmpty()) {
                        ...
                        items(items = groups, key = { "${it.relayUrl}|${it.groupId}" }) { entry ->
                            Box(modifier = Modifier.padding(horizontal = 12.dp)) {
                                com.darkwisp.app.ui.component.GroupCard(
